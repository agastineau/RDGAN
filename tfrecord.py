...
data_dir_train='F:/Anais/Tests_methode_sentinel_database/sentinel_database'
data_dir_test='F:/Anais/Tests_methode_sentinel_database/sentinel_database'
testlist=['%s/%d'%(data_dir_test,number) for number in range(6000,7189)]
trainfiles=['%s/%d'%(data_dir_train,number) for number in range(6000)]
output_dir="F:/Anais/Tests_methode_sentinel_database/tfrecord"
